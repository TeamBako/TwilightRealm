...
Shader "Nature/SpeedTree_Transparent"
{
    Properties
    {
            ...
            Pass
            {
                ...
                CGPROGRAM
                    ...
                    fixed4 frag(v2f i) : SV_Target
                    {
                            ...
                            //fixed4 c = fixed4(o.Albedo, o.Alpha);
                            fixed4 c = tex2Dproj(_GrabTexture, i.uvgrab) * (1 - _Transparency) + tex2Dproj(_GrabFondScene, i.uvgrab) * _Transparency;
                            UNITY_APPLY_FOG(i.fogCoord, c);
                            return c;
                    }
                ENDCG
